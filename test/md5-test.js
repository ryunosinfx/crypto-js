	...
	Y => {
		...
		Y.Test.Runner.add(
			new Y.Test.Case({
				...
				testVector1: () => Y.Assert.areEqual('d41d8cd98f00b204e9800998ecf8427e', C.MD5('').toString()),
				testVector2: () => Y.Assert.areEqual('0cc175b9c0f1b6a831c399e269772661', C.MD5('a').toString()),
				testVector3: () => Y.Assert.areEqual('900150983cd24fb0d6963f7d28e17f72', C.MD5('abc').toString()),
				testVector4: () =>
				...
				testHelper: () => Y.Assert.areEqual(C.algo.MD5.create().finalize('').toString(), C.MD5('').toString()),
				testHmacHelper: () =>
					Y.Assert.areEqual(
